...
legend(
        "topright",
        legend = paste("平均 =", round(math_mean, 1)),
        col = "red",
        lty = 2,
        lwd = 2
)
...
legend(
        "topright",
        legend = paste("平均 =", round(eng_mean, 1)),
        col = "red",
        lty = 2,
        lwd = 2
)
...
print(paste(
        "数学と英語の相関の強さ:",
        interpret_correlation(correlation_math_eng)
))
...
print(paste(
        "最も数学平均の高い学部:",
        major_math_mean$major[which.max(major_math_mean$math_score)]
))
